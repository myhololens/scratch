...
/**
 * GUIEchoDisplay component passes a file input, load handler and props to its child.
 ...
 *
 * <GUIEchoDisplay>{(renderFileInput, loadProject) => (
 *     <MyCoolComponent
 *         onClick={loadProject}
 *     >
 *         {renderFileInput()}
...
class GUIEchoDisplay extends React.Component {
    constructor (props) {
        super(props);
        bindAll(this, [
