            ...
            window.plugin.start(), window.plugin.publish = () => {
                projectFilepromise.then(sb3 => {
                    let form = new FormData()
                        ...
                        form.append('poster', window._video.poster)
                            ...
                            <React.Fragment>
                                ...
                                <div className={classNames(styles.menuBarItem)}>
                                    <SB3Saveloader>{(projectFilename, projectFilepromise) => (
                                        <ShareButton 
                                            className={styles.menuBarButton}
                                            onClick={this.handlePushToCloud(projectFilename, projectFilepromise)}
                                        />
                                    )}</SB3Saveloader>
                                </div>
                            </React.Fragment>
                                    ...
                                    */}
                                    {
                                        this.state.nickname && (
                                            ...
                                            >
                                                ...
                                                >
                                                    <MenuSection>
                                                        <MenuItem onClick={() => alert('我的衣服')}>
                                                            我的衣服
                                                        </MenuItem>
                                                        <MenuItem onClick={() => alert('我的裤子')}>
                                                            我的裤子
                                                        </MenuItem>
                                                        <MenuItem onClick={() => alert('我的鞋子')}>
                                                            我的鞋子
                                                        </MenuItem>
                                                    </MenuSection>
                                                </MenuBarMenu>
